...
@section('content')
    <section class="page-hero">
        ...
        <p class="page-copy">TeaManjur blends strategy, Laravel engineering, clean interface design, automation thinking, and AI integration to help teams turn ideas into dependable products.</p>
    </section>
