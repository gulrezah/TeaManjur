...
@section('content')
    <section class="page-hero">
        ...
        <p class="page-copy">TeaManjur covers the core pieces of a modern web presence: strategy, design, Laravel development, AI workflow integration, automation, and mobile app promotion.</p>
    </section>
    ...
    <section class="content-band">
        <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            @foreach ([
                ...
                ['Laravel Solutions', 'Custom Laravel applications, admin panels, APIs, and maintainable backend systems.'],
